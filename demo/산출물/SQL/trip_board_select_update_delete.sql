...
update trip_board set t_bo_title='제목수정',t_bo_content='내용수정',t_bo_person=3,
                        t_bo_img='img11.png',t_bo_start_date='2023-05-11',t_bo_end_date='2023-05-20',t_bo_style='느긋한',hashtag='즉흥적',city_no=3 where t_bo_no=6;

-- 게시글 삭제
delete trip_board where n_no=7;

-- 게시글 번호로 게시물 1개 보기
select t_bo_no, t_bo_title, t_bo_content, t_bo_date, t_bo_readcount, t_bo_status, t_bo_person,
        t_bo_img,t_bo_start_date,t_bo_end_date,t_bo_style,hashtag,city_no,user_id from trip_board where t_bo_no=8;

-- 게시판 리스트 보기
select t_bo_no, t_bo_title, t_bo_content, t_bo_date, t_bo_readcount, t_bo_status, t_bo_person,
        t_bo_img,t_bo_start_date,t_bo_end_date,t_bo_style,hashtag,city_no,user_id from trip_board order by t_bo_no desc;
